...
def join_tables(base_node_id: str, join_path_list: List, join_tree: Dict, partial_join_name=None, partial_join=None):
    ...
    for node in join_tree[base_node_id].keys():
        if (node == "/Users/andra/Developer/auto-data-augmentation/data/ARDA/school/sat.csv") or (node == "/Users/andra/Developer/auto-data-augmentation/data/ARDA/school/gender.csv"):
            continue
